 ...
 *   Modified by CaiHaozhong, 2017.3.1
 *                                                                           *
\*===========================================================================*/
...
protected:
	/* Hook By CaiHaozhong */
	virtual void onBeginInitializeGL(){};
	virtual void onEndInitializeGL(){};
	virtual void onBeginReshapeWindow(int w, int h ){};
	virtual void onEndReshapeWindow(int w, int h ){};
protected:
