...
namespace geodesic{
	unsigned geodesic::Mesh::closest_vertices(SurfacePoint* p, 
...
// 	void geodesic::Mesh::initialize_mesh_data(Points& p, Faces& tri)		//build mesh from regular point-triangle representation
// 	{
// 		assert(p.size() % 3 == 0);
...
// 	}
	...
	void geodesic::Mesh::build_adjacencies()
	{
	...
	bool geodesic::Mesh::verify()		//verifies connectivity of the mesh and prints some debug info
	{
		std::cout << std::endl;
