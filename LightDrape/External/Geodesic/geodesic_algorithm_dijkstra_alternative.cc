...
unsigned geodesic::GeodesicAlgorithmDijkstraAlternative::best_source(SurfacePoint& point,			//quickly find what source this point belongs to and what is the distance to this source
...
void geodesic::GeodesicAlgorithmDijkstraAlternative::trace_back(SurfacePoint& destination,		//trace back piecewise-linear path
...
void geodesic::GeodesicAlgorithmDijkstraAlternative::propagate(std::vector<SurfacePoint>& sources,
...
bool geodesic::GeodesicAlgorithmDijkstraAlternative::check_stop_conditions(unsigned& index)
{
