...
namespace geodesic{
	void geodesic::GeodesicAlgorithmExact::best_point_on_the_edge_set(SurfacePoint& point, 
	...
	void geodesic::GeodesicAlgorithmExact::possible_traceback_edges(SurfacePoint& point, 
	...
	long geodesic::GeodesicAlgorithmExact::visible_from_source(SurfacePoint& point)	//negative if not visible
	{
	...
	double geodesic::GeodesicAlgorithmExact::compute_positive_intersection(double start,
																		double pseudo_x,
																		double pseudo_y,
																		double sin_alpha,
																		double cos_alpha)
	...
	void geodesic::GeodesicAlgorithmExact::list_edges_visible_from_source(MeshElementBase* p,
																	   std::vector<edge_pointer>& storage)
	{
	...
	bool geodesic::GeodesicAlgorithmExact::erase_from_queue(interval_pointer p)
	{
	...
	unsigned geodesic::GeodesicAlgorithmExact::intersect_intervals(interval_pointer zero, 
	...
	void geodesic::GeodesicAlgorithmExact::initialize_propagation_data()
	{
		clear();
	...
	bool geodesic::GeodesicAlgorithmExact::check_stop_conditions(unsigned& index)
	{
	...
	void geodesic::GeodesicAlgorithmExact::update_list_and_queue(list_pointer list,
	...
	unsigned geodesic::GeodesicAlgorithmExact::compute_propagated_parameters(double pseudo_x, 
																			double pseudo_y, 
	...
	void geodesic::GeodesicAlgorithmExact::construct_propagated_intervals(bool invert, 
																		edge_pointer edge, 
	...
	unsigned geodesic::GeodesicAlgorithmExact::best_source(SurfacePoint& point,			//quickly find what source this point belongs to and what is the distance to this source
	...
	geodesic::interval_pointer geodesic::GeodesicAlgorithmExact::best_first_interval(SurfacePoint& point, 
																 double& best_total_distance, 
																 double& best_interval_position, 
																 unsigned& best_source_index)
	{
		...
		geodesic::interval_pointer best_interval = NULL;	
	...
	void geodesic::GeodesicAlgorithmExact::trace_back(SurfacePoint& destination,		//trace back piecewise-linear path
